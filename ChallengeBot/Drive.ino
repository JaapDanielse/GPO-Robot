...
//-----------------------------------------------------------------------------------------------
boolean driveTurn(int turnDegrees, byte obstacleDistWarning )
...
//-----------------------------------------------------------------------------------------------
int driveTurnDone()
{ // returns the number of degrees turned (since last turn start) 
  
  return ((( abs(driveSensor1Count) + abs(driveSensor2Count))/2) * 9) ;
